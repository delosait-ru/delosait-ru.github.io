...
function init() {
    ...
    function checkState() {
        ...
        if ($('#orange').prop('checked')) {
            ...
            byColor = myObjects.search('options.fillColor = "#f15a25"')
                .add(myObjects.search('options.preset = "islands#orangeIcon"'));
        }
        if ($('#blue').prop('checked')) {
            byColor = myObjects.search('options.fillColor = "#1b1564"')
                .add(myObjects.search('options.preset = "islands#blueIcon"'))
    ...
    $('#orange').click(checkState);
    $('#blue').click(checkState);
