...
<div id="wb_Shape1">
<a href="" onclick="ShowObjectWithEffect('overlay', 1, 'fade', 300);ShowObjectWithEffect('modal', 1, 'dropdown', 500);return false;"><img class="hover" src="images/img0001_hover.png" alt="" id="wb_uid7"><span class="default"><img src="images/img0001.png" id="Shape1" alt="" data-fancybox data-src="#buy" href="javascript:;"></span></a></div>
</div>
</div>
<div id="Layer6">
...
<div id="wb_Text35">
<span id="wb_uid35"><a href="./politica.php" class="phoneform">Политика конфиденциальности</a></span></div>
...
<div id="wb_Text50">
<span id="wb_uid49"><a href="./politica.php" class="phoneform">Политика конфиденциальности</a></span></div>
</form>
</div>
</div>
...
<form name="Form-modal" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_blank" id="modal">
...
<div id="wb_Text51">
<span id="wb_uid51"><a href="./politica.php" class="phoneform">Политика конфиденциальности</a></span></div>
<div id="wb_Text49">
